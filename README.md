...
For the next challenge, we will be watching semantic, design patterns, framework knowledge( if used ), code order, best practices and the correct use of the rules and tools.


We need to build an app where the countries of the world can be listed from the provided endpoint and the detail of the country

could be shown when clicked on it, for this we’re gonna have the following requirements
